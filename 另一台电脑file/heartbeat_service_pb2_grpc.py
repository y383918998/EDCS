...
class HeartbeatServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Ping = channel.unary_unary(
                '/objectrepo.HeartbeatService/Ping',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                _registered_method=True)
        self.GetUptime = channel.unary_unary(
                '/objectrepo.HeartbeatService/GetUptime',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
...
def add_HeartbeatServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'objectrepo.HeartbeatService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('objectrepo.HeartbeatService', rpc_method_handlers)
